...
knitr::include_graphics("images/LC-MS-data.png")
```

<div> - Standard file format: mzML.</div>
<div> - Data organized by spectrum.</div>
...
## MS data handling with `MSnbase`

- Data organized by spectrum.
...
- Extract a single spectrum with `data[[3]]`.

<div style="position:absolute; left:20%; top:40%">
```{r out.width = "500px", echo = FALSE}
knitr::include_graphics("images/LC-MS-data-spectrum.png")
```
</div>
...
- Extract chromatographic data: `chromatogram(data, mz = mz, rt = rt)`.

<div style="position:absolute; left:20%; top:40%">
```{r out.width = "500px", echo = FALSE}
knitr::include_graphics("images/LC-MS-data-chromatogram1.png")
```
</div>
...
<div style="position:absolute; left:20%; top:40%">
```{r out.width = "500px", echo = FALSE}
knitr::include_graphics("images/LC-MS-data-chromatogram2.png")
```
</div>
...
- Extract chromatographic data: `chromatogram(data, mz = mz, rt = rt)`.
- Intensities aggregated along m/z dimension.

<div style="position:absolute; left:20%; top:40%">
```{r out.width = "500px", echo = FALSE}
knitr::include_graphics("images/LC-MS-data-chromatogram3.png")
```
</div>
...
- Example compound, mirror plot against DDA and Metlin.

## Annotating MS2 spectra {.build}

- Export spectra and peak/feature intensities to GNPS.
