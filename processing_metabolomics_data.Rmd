...
## Annotating MS2 spectra {.build .smaller}
...
knitr::include_graphics("images/CompoundDb-01.png")
```
</div>

## Annotating MS2 spectra {.smaller}
...
<div style="position:absolute; left:25%; top:55%">
```{r out.width = "400px", echo = FALSE}
knitr::include_graphics("images/CompoundDb-02.png")
```
</div>
...
<div style="position:absolute; left:25%; top:55%">
```{r out.width = "400px", echo = FALSE}
knitr::include_graphics("images/CompoundDb-03.png")
```
</div>
...
- Define a efficient, expandable, flexible and well documented infrastructure
